...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="contact-area after-none contact-bg p-relative fix py-12 lg:py-24"
    >
            ...
            <div className="contact-info">
              ...
              >
                ...
                <div className="flex flex-col">
                  <h5>Dirección</h5>
                  <p>
                    C. Guillermo Gonzalez Camarena 1600-INT. 3B, Santa Fe, Sta
                    Fé, Álvaro Obregón, 01210 Ciudad de México, CDMX
                  </p>
                </div>
              </div>
              <div
